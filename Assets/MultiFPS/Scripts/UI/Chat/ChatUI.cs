...
namespace MultiFPS.UI
{
    ...
    {
        public static ChatUI _instance;
     ...
     //   [SerializeField] ContentBackground _background;
        ...
        public void Send()
        {
            if (string.IsNullOrWhiteSpace(MessageGet())) { return; }
            ClientFrontend.ClientPlayerInstance.GetComponent<ChatBehaviour>().CmdRelayClientMessage(GameTools.CheckMessageLength(ChatUI._instance.MessageGet()));
        }
