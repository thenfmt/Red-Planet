...
namespace MultiFPS.Gameplay
{
    public class PlayerInstance : NetworkBehaviour
    {
        ...
        private void Awake()
        {
            CustomNetworkManager.Instance.OnNewPlayerConnected += UpdateDataForLatePlayer;
        ...
        public void Server_SpawnCharacter(Transform spawnPoint) 
        {
            ...
            var characterPrefab = NetworkManager.singleton.spawnPrefabs[PlayerInfo.AgentID];

            
            MyCharacter = Instantiate(characterPrefab, spawnPoint.position, spawnPoint.rotation).GetComponent<CharacterInstance>();
