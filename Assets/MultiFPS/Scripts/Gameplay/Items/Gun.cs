...
namespace MultiFPS.Gameplay
{
    ...
    public class Gun : Item
    {
        ...
        [SerializeField] private float RigidBodyForce = 2500;
        [SerializeField] private float _secondaryAttackCooldown = 0.5f;
        [SerializeField] protected AudioClip secondaryFireClip;
        ...
        protected override bool CooldownSecondary()
        {
            ...
            {
                _meleeCoolDownTimer = Time.time + _secondaryAttackCooldown;
                return true;
            }
            else return false;
        }
        ...
        void SpawnThrowable() 
        {
            ...
            _audioSource.PlayOneShot(secondaryFireClip);

            GameObject throwable = Instantiate(ThrowablePrefab, _particleSystem.transform.position, Quaternion.Euler(_myOwner.lookInput.x, _myOwner.lookInput.y, 0));
